              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Delete {selectedIds.length} prescription(s)? This cannot be
                    undone.
                  </p>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
                ...
                <button onClick={() => setViewPrescription(null)}>✕</button>
              </div>
              <div className="p-6 space-y-3 text-sm text-gray-800 dark:text-gray-200">
                ...
                <p>
                  <strong>Doctor:</strong> {viewPrescription.doctor_id}
                </p>
                <p>
                  <strong>Patient:</strong> {viewPrescription.patient_id}
                </p>
                <p>
                  <strong>Diagnosis:</strong>{" "}
                  {viewPrescription.diagnosis || "N/A"}
                </p>
                <p>
                  <strong>Notes:</strong> {viewPrescription.notes || "N/A"}
                </p>
                <p>
                  <strong>Date:</strong>{" "}
                  {new Date(viewPrescription.created_at).toLocaleString()}
                </p>
              </div>
